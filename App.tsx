    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 md:p-8">
      ...
      <main className="w-full max-w-4xl z-10">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white tracking-tight">Titan<span className="text-blue-500">Calc</span></h1>
          <p className="text-slate-400 mt-2">Precision engineering for the modern web</p>
        </div>
        
        <ScientificCalculator />
        
        <footer className="mt-8 text-center text-slate-500 text-sm">
          <p>© {new Date().getFullYear()} TitanCalc Engineering. High-precision computations.</p>
        </footer>
      </main>
    </div>
  );
